...
in {
  colors = {
    inherit (colors) bg fg black dark_gray dark_red light_red dark_green light_green dark_yellow light_yellow dark_blue light_blue dark_magenta light_magenta dark_cyan light_cyan light_cyan white;
